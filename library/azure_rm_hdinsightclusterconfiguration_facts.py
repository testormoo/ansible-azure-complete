...
DOCUMENTATION = '''
---
module: azure_rm_hdinsightclusterconfiguration_facts
version_added: "2.8"
short_description: Get Azure Configuration facts.
description:
    - Get facts of Configuration.
...
EXAMPLES = '''
  - name: Get instance of Configuration
    azure_rm_hdinsightclusterconfiguration_facts:
...
RETURN = '''
configurations:
    description: A list of dictionaries containing facts for Configurations.
    returned: always
    type: complex
    contains:
'''
