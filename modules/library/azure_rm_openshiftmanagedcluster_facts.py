...
DOCUMENTATION = '''
---
module: azure_rm_openshiftmanagedcluster_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get instance of Open Shift Managed Cluster
    azure_rm_openshiftmanagedcluster_facts:
...
class AzureRMOpenShiftManagedClustersFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.tags = None
        super(AzureRMOpenShiftManagedClustersFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for OpenShiftManagedClusters.')
...
def main():
    AzureRMOpenShiftManagedClustersFacts()
