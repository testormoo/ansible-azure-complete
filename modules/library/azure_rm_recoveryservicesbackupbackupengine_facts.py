...
class AzureRMBackupEnginesFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.tags = None
        super(AzureRMBackupEnginesFacts, self).__init__(self.module_arg_spec, supports_tags=False)
