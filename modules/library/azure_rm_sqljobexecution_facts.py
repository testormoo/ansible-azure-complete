...
DOCUMENTATION = '''
---
module: azure_rm_sqljobexecution_facts
version_added: "2.8"
short_description: Get Azure Job Execution facts.
description:
    - Get facts of Azure Job Execution.
...
EXAMPLES = '''
  - name: List instances of Job Execution
    azure_rm_sqljobexecution_facts:
  ...
  - name: Get instance of Job Execution
    azure_rm_sqljobexecution_facts:
      resource_group: resource_group_name
      server_name: server_name
      job_agent_name: job_agent_name
...
RETURN = '''
job_executions:
    description: A list of dictionaries containing facts for Job Execution.
    returned: always
    type: complex
    contains:
        id:
            ...
            sample: "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/group1/providers/Microsoft.Sql/servers/server1/jobAgents/agent1/jobs/
                    job1/executions/5555-6666-7777-8888-999999999999"
        name:
            description:
                - Resource name.
            returned: always
            type: str
            sample: 5555-6666-7777-8888-999999999999
        lifecycle:
            description:
...
class AzureRMJobExecutionsFacts(AzureRMModuleBase):
    ...
    def list_by_job(self):
        ...
        results = []
        try:
            response = self.mgmt_client.job_executions.list_by_job(resource_group_name=self.resource_group,
    ...
    def list_by_agent(self):
        ...
        results = []
        try:
            response = self.mgmt_client.job_executions.list_by_agent(resource_group_name=self.resource_group,
                                                                     server_name=self.server_name,
                                                                     job_agent_name=self.job_agent_name)
            self.log("Response : {0}".format(response))
        except CloudError as e:
