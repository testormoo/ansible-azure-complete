...
class AzureRMWorkflowRunActionFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.run_name = None
        self.name = None
        super(AzureRMWorkflowRunActionFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Workflow Run Action.')
