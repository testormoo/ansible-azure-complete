...
EXAMPLES = '''
  - name: Create (or update) Frontend Endpoint
    azure_rm_frontdoorfrontendendpoint:
      ...
      frontend_endpoint_name: frontDoorEndpoint1
...
class AzureRMFrontendEndpoints(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Frontend Endpoint instance has to be deleted or may be updated")
    ...
    def create_update_frontendendpoint(self):
        ...
        '''
        self.log("Creating / Updating the Frontend Endpoint instance {0}".format(self.frontend_endpoint_name))
    ...
    def delete_frontendendpoint(self):
        ...
        :return: True
        '''
        self.log("Deleting the Frontend Endpoint instance {0}".format(self.frontend_endpoint_name))
        try:
    ...
    def get_frontendendpoint(self):
        ...
        :return: deserialized Frontend Endpoint instance state dictionary
        '''
        self.log("Checking if the Frontend Endpoint instance {0} is present".format(self.frontend_endpoint_name))
        found = False
        try:
