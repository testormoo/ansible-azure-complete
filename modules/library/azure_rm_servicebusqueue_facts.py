...
class AzureRMQueueFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.top = None
        self.name = None
        super(AzureRMQueueFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def list_by_namespace(self):
        ...
        try:
            ...
            self.log('Could not get facts for Queue.')
