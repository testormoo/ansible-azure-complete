...
DOCUMENTATION = '''
---
module: azure_rm_hanaonazurehanainstance_facts
version_added: "2.8"
short_description: Get Azure Hana Instance facts.
description:
    - Get facts of Azure Hana Instance.
...
RETURN = '''
hana_instances:
    description: A list of dictionaries containing facts for Hana Instance.
    returned: always
    type: complex
    contains:
        id:
            ...
            returned: always
            type: str
            sample: "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.HanaOnAzure/hanaInstances/myHanaI
                    nstance"
        name:
            description:
                - Resource name
