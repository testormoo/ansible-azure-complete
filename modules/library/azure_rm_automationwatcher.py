...
class AzureRMWatcher(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Watcher instance has to be deleted or may be updated")
    ...
    def create_update_watcher(self):
        ...
        '''
        self.log("Creating / Updating the Watcher instance {0}".format(self.watcher_name))
    ...
    def delete_watcher(self):
        ...
        :return: True
        '''
        self.log("Deleting the Watcher instance {0}".format(self.watcher_name))
        try:
    ...
    def get_watcher(self):
        ...
        :return: deserialized Watcher instance state dictionary
        '''
        self.log("Checking if the Watcher instance {0} is present".format(self.watcher_name))
        found = False
        try:
