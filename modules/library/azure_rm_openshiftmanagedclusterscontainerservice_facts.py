...
DOCUMENTATION = '''
---
module: azure_rm_openshiftmanagedclusterscontainerservice_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get instance of Container Service
    azure_rm_openshiftmanagedclusterscontainerservice_facts:
...
class AzureRMContainerServicesFacts(AzureRMModuleBase):
    def __init__(self):
