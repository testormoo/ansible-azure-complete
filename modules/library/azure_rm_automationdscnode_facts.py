...
DOCUMENTATION = '''
---
module: azure_rm_automationdscnode_facts
version_added: "2.8"
short_description: Get Azure Dsc Node facts.
description:
    - Get facts of Azure Dsc Node.
...
RETURN = '''
dsc_node:
    description: A list of dictionaries containing facts for Dsc Node.
    returned: always
    type: complex
    contains:
        id:
            ...
            returned: always
            type: str
            sample: /subscriptions/subid/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/myAutomationAccount33/nodes/nodeId
        name:
            description:
...
class AzureRMDscNodeFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.node_id = None
        super(AzureRMDscNodeFacts, self).__init__(self.module_arg_spec, supports_tags=False)
