...
DOCUMENTATION = '''
---
module: azure_rm_relaynamespace_facts
version_added: "2.8"
...
namespaces:
    ...
    contains:
        id:
            ...
            returned: always
            type: str
            sample: /subscriptions/8c246e6a-cbc6-4a87-aff1-d6a886f376ef/resourceGroups/RG-eg/providers/Microsoft.Relay/namespaces/sdk-RelayNamespace-01
        name:
            description:
                - Resource name.
            returned: always
            type: str
            sample: sdk-RelayNamespace-01
        location:
            description:
                - Resource location.
            returned: always
