...
DOCUMENTATION = '''
---
module: azure_rm_adhybridhealthserviceservicemember_facts
version_added: "2.8"
short_description: Get Azure Service Member facts.
description:
...
RETURN = '''
service_members:
    description: A list of dictionaries containing facts for Service Member.
    returned: always
    type: complex
    contains:
        dimensions:
...
class AzureRMServiceMemberFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        super(AzureRMServiceMemberFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['service_members'] = self.get()
        return self.results
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Service Member.')
