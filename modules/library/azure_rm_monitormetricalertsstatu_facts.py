...
DOCUMENTATION = '''
---
module: azure_rm_monitormetricalertsstatu_facts
version_added: "2.8"
short_description: Get Azure Metric Alerts Statu facts.
description:
    - Get facts of Azure Metric Alerts Statu.
...
EXAMPLES = '''
  - name: List instances of Metric Alerts Statu
    azure_rm_monitormetricalertsstatu_facts:
...
metric_alerts_status:
    description: A list of dictionaries containing facts for Metric Alerts Statu.
    returned: always
    type: complex
    contains:
'''
