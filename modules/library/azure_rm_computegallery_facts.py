...
DOCUMENTATION = '''
---
module: azure_rm_computegallery_facts
version_added: "2.8"
short_description: Get Azure Gallery facts.
description:
    - Get facts of Azure Gallery.
...
RETURN = '''
galleries:
    description: A list of dictionaries containing facts for Gallery.
    returned: always
    type: complex
    contains:
        id:
