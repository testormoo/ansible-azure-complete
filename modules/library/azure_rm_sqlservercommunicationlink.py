...
version_added: "2.8"
short_description: Manage Azure Server Communication Link instance.
description:
    - Create, update and delete instance of Azure Server Communication Link.
...
class AzureRMServerCommunicationLink(AzureRMModuleBase):
