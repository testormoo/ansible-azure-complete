...
description:
    - Get facts of Azure MySQL Database.
...
RETURN = '''
databases:
    description: A list of dictionaries containing facts for MySQL Database.
    returned: always
    type: complex
    contains:
        id:
...
class AzureRMMySQLDatabaseFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for MySQL Database.')
