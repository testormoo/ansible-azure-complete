...
class AzureRMApplicationGatewayFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        self.tags = None
        super(AzureRMApplicationGatewayFacts, self).__init__(self.module_arg_spec, supports_tags=False)
...
def main():
    AzureRMApplicationGatewayFacts()
