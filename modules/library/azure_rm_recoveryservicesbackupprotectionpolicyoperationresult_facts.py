...
class AzureRMProtectionPolicyOperationResultsFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.tags = None
        super(AzureRMProtectionPolicyOperationResultsFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for ProtectionPolicyOperationResults.')
...
def main():
    AzureRMProtectionPolicyOperationResultsFacts()
