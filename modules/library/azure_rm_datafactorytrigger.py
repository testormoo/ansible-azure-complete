...
class AzureRMTriggers(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Trigger instance has to be deleted or may be updated")
    ...
    def create_update_trigger(self):
        ...
        '''
        self.log("Creating / Updating the Trigger instance {0}".format(self.trigger_name))
    ...
    def delete_trigger(self):
        ...
        :return: True
        '''
        self.log("Deleting the Trigger instance {0}".format(self.trigger_name))
        try:
    ...
    def get_trigger(self):
        ...
        :return: deserialized Trigger instance state dictionary
        '''
        self.log("Checking if the Trigger instance {0} is present".format(self.trigger_name))
        found = False
        try:
