...
DOCUMENTATION = '''
---
module: azure_rm_applicationinsightscomponentquotastatus_facts
version_added: "2.8"
short_description: Get Azure Component Quota Status facts.
description:
    - Get facts of Azure Component Quota Status.
...
EXAMPLES = '''
  - name: Get instance of Component Quota Status
    azure_rm_applicationinsightscomponentquotastatus_facts:
...
component_quota_status:
    description: A list of dictionaries containing facts for Component Quota Status.
    returned: always
    type: complex
    contains:
'''
...
class AzureRMComponentQuotaStatusFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Component Quota Status.')
