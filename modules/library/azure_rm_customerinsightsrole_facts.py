...
class AzureRMRoleFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        super(AzureRMRoleFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def list_by_hub(self):
        ...
        try:
            ...
            self.log('Could not get facts for Role.')
