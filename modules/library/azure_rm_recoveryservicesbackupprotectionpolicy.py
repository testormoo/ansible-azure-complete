...
version_added: "2.8"
short_description: Manage Azure Protection Policy instance.
description:
    - Create, update and delete instance of Azure Protection Policy.
...
class AzureRMProtectionPolicy(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMProtectionPolicy, self).__init__(derived_arg_spec=self.module_arg_spec,
    ...
    def exec_module(self, **kwargs):
        ...
        dict_expand(self.parameters, ['protected_items_count'])
