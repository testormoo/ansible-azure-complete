...
version_added: "2.8"
short_description: Manage Linked Server instance.
description:
    - Create, update and delete instance of Linked Server.
    ...
    def exec_module(self, **kwargs):
        ...
        for key in list(self.module_arg_spec.keys()) + ['tags']:
            if hasattr(self, key):
                ...
                if key == "linked_redis_cache_id":
                    self.parameters["linked_redis_cache_id"] = kwargs[key]
                elif key == "linked_redis_cache_location":
                    self.parameters["linked_redis_cache_location"] = kwargs[key]
                elif key == "server_role":
                    self.parameters["server_role"] = _snake_to_camel(kwargs[key], True)
