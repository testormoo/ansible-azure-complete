...
version_added: "2.8"
short_description: Manage Server Blob Auditing Policy instance.
description:
    - Create, update and delete instance of Server Blob Auditing Policy.
...
class AzureRMServerBlobAuditingPolicies(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMServerBlobAuditingPolicies, self).__init__(derived_arg_spec=self.module_arg_spec,
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            ...
            while self.get_serverblobauditingpolicy():
                time.sleep(20)
        else:
...
def main():
    """Main execution"""
    AzureRMServerBlobAuditingPolicies()
