...
version_added: "2.8"
short_description: Manage W C F Relay instance.
description:
    - Create, update and delete instance of W C F Relay.
...
class AzureRMWCFRelays(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMWCFRelays, self).__init__(derived_arg_spec=self.module_arg_spec,
    ...
    def exec_module(self, **kwargs):
        ...
        for key in list(self.module_arg_spec.keys()) + ['tags']:
            if hasattr(self, key):
                ...
                if key == "relay_type":
                    self.parameters["relay_type"] = _snake_to_camel(kwargs[key], True)
                elif key == "requires_client_authorization":
                    self.parameters["requires_client_authorization"] = kwargs[key]
                elif key == "requires_transport_security":
                    self.parameters["requires_transport_security"] = kwargs[key]
                elif key == "user_metadata":
                    self.parameters["user_metadata"] = kwargs[key]
