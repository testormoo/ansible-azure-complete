...
class AzureRMCloudEndpointFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        super(AzureRMCloudEndpointFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Cloud Endpoint.')
