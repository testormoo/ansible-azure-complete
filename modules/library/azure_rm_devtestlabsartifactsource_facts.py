...
class AzureRMArtifactSourceFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.expand = None
        self.tags = None
        super(AzureRMArtifactSourceFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Artifact Source.')
