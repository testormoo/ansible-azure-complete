...
class AzureRMApps(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if App instance has to be deleted or may be updated")
    ...
    def create_update_app(self):
        ...
        '''
        self.log("Creating / Updating the App instance {0}".format(self.resource_name))
    ...
    def delete_app(self):
        ...
        :return: True
        '''
        self.log("Deleting the App instance {0}".format(self.resource_name))
        try:
    ...
    def get_app(self):
        ...
        :return: deserialized App instance state dictionary
        '''
        self.log("Checking if the App instance {0} is present".format(self.resource_name))
        found = False
        try:
