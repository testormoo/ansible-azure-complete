...
class AzureRMWorkflowVersionFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.tags = None
        super(AzureRMWorkflowVersionFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Workflow Version.')
