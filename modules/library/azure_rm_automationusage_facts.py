...
DOCUMENTATION = '''
---
module: azure_rm_automationusage_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: List instances of Usage
    azure_rm_automationusage_facts:
...
class AzureRMUsagesFacts(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['usages'] = self.list_by_automation_account()
        return self.results
    ...
    def list_by_automation_account(self):
        ...
        results = []
        try:
            response = self.mgmt_client.usages.list_by_automation_account(resource_group_name=self.resource_group,
