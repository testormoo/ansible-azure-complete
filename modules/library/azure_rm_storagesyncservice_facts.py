...
DOCUMENTATION = '''
---
module: azure_rm_storagesyncservice_facts
version_added: "2.8"
short_description: Get Azure Storage Sync Service facts.
description:
    - Get facts of Azure Storage Sync Service.
...
storage_sync_services:
    description: A list of dictionaries containing facts for Storage Sync Service.
    returned: always
    type: complex
    contains:
        id:
            ...
            sample: "/subscriptions/3a048283-338f-4002-a9dd-a50fdadcb392/resourceGroups/SampleResourceGroup_1/providers/Microsoft.StorageSync/storageSyncServ
                    ices/SampleStorageSyncService_1"
        name:
            description:
                - The name of the resource
            returned: always
            type: str
            sample: SampleStorageSyncService_1
        tags:
            description:
                - Resource tags.
            returned: always
...
class AzureRMStorageSyncServiceFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        self.tags = None
        super(AzureRMStorageSyncServiceFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group is not None and
            ...
            self.results['storage_sync_services'] = self.list_by_subscription()
        return self.results
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Storage Sync Service.')
    ...
    def list_by_resource_group(self):
        ...
        results = []
        try:
            response = self.mgmt_client.storage_sync_services.list_by_resource_group(resource_group_name=self.resource_group)
            self.log("Response : {0}".format(response))
        except CloudError as e:
            self.log('Could not get facts for Storage Sync Service.')
...
def main():
    AzureRMStorageSyncServiceFacts()
