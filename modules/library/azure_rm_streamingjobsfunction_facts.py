...
DOCUMENTATION = '''
---
module: azure_rm_streamingjobsfunction_facts
version_added: "2.8"
short_description: Get Azure Function facts.
description:
    - Get facts of Azure Function.
...
RETURN = '''
functions:
    description: A list of dictionaries containing facts for Function.
    returned: always
    type: complex
    contains:
        id:
            ...
            returned: always
            type: str
            sample: "/subscriptions/56b5e0a9-b645-407d-99b0-c64f86013e3d/resourceGroups/sjrg7/providers/Microsoft.StreamAnalytics/streamingjobs/sj9093/functi
                    ons/function588"
        name:
            description:
                - Resource name
...
class AzureRMFunctionFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        self.select = None
        super(AzureRMFunctionFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Function.')
    ...
    def list_by_streaming_job(self):
        ...
        results = []
        try:
            response = self.mgmt_client.functions.list_by_streaming_job(resource_group_name=self.resource_group,
                                                                        job_name=self.job_name)
            self.log("Response : {0}".format(response))
        except CloudError as e:
            self.log('Could not get facts for Function.')
