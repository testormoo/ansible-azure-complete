...
class AzureRMCredential(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Credential instance has to be deleted or may be updated")
    ...
    def create_update_credential(self):
        ...
        '''
        self.log("Creating / Updating the Credential instance {0}".format(self.credential_name))
    ...
    def delete_credential(self):
        ...
        :return: True
        '''
        self.log("Deleting the Credential instance {0}".format(self.credential_name))
        try:
    ...
    def get_credential(self):
        ...
        :return: deserialized Credential instance state dictionary
        '''
        self.log("Checking if the Credential instance {0} is present".format(self.credential_name))
        found = False
        try:
