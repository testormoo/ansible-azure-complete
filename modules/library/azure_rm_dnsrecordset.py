...
version_added: "2.8"
short_description: Manage Record Set instance.
description:
    - Create, update and delete instance of Record Set.
...
class AzureRMRecordSets(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMRecordSets, self).__init__(derived_arg_spec=self.module_arg_spec,
        ...
        for key in list(self.module_arg_spec.keys()) + ['tags']:
            if hasattr(self, key):
                ...
                if key == "metadata":
                    ...
                    self.parameters["ttl"] = kwargs[key]
                elif key == "target_resource":
                    self.parameters["target_resource"] = kwargs[key]
                elif key == "arecords":
                    self.parameters["arecords"] = kwargs[key]
                elif key == "aaaa_records":
                    self.parameters["aaaa_records"] = kwargs[key]
                elif key == "mx_records":
                    self.parameters["mx_records"] = kwargs[key]
                elif key == "ns_records":
                    self.parameters["ns_records"] = kwargs[key]
                elif key == "ptr_records":
                    self.parameters["ptr_records"] = kwargs[key]
                elif key == "srv_records":
                    self.parameters["srv_records"] = kwargs[key]
                elif key == "txt_records":
                    self.parameters["txt_records"] = kwargs[key]
                elif key == "cname_record":
                    self.parameters["cname_record"] = kwargs[key]
                elif key == "soa_record":
                    self.parameters["soa_record"] = kwargs[key]
                elif key == "caa_records":
                    self.parameters["caa_records"] = kwargs[key]
