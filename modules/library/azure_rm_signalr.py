...
version_added: "2.8"
short_description: Manage Signal R instance.
description:
    - Create, update and delete instance of Signal R.
...
class AzureRMSignalR(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        for key in list(self.module_arg_spec.keys()) + ['tags']:
            if hasattr(self, key):
                ...
                elif key == "host_name_prefix":
                    self.parameters.setdefault("properties", {})["host_name_prefix"] = kwargs[key]
                elif key == "location":
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Signal R instance has to be deleted or may be updated")
    ...
    def create_update_signalr(self):
        ...
        '''
        self.log("Creating / Updating the Signal R instance {0}".format(self.resource_name))
    ...
    def delete_signalr(self):
        ...
        :return: True
        '''
        self.log("Deleting the Signal R instance {0}".format(self.resource_name))
        try:
    ...
    def get_signalr(self):
        ...
        :return: deserialized Signal R instance state dictionary
        '''
        self.log("Checking if the Signal R instance {0} is present".format(self.resource_name))
        found = False
        try:
