...
DOCUMENTATION = '''
---
module: azure_rm_openshiftmanagedclustersmanagedcluster
version_added: "2.8"
...
EXAMPLES = '''
  - name: Create (or update) Managed Cluster
    azure_rm_openshiftmanagedclustersmanagedcluster:
      resource_group: rg1
...
class AzureRMManagedClusters(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Managed Cluster instance has to be deleted or may be updated")
    ...
    def create_update_managedcluster(self):
        ...
        '''
        self.log("Creating / Updating the Managed Cluster instance {0}".format(self.resource_name))
    ...
    def delete_managedcluster(self):
        ...
        :return: True
        '''
        self.log("Deleting the Managed Cluster instance {0}".format(self.resource_name))
        try:
    ...
    def get_managedcluster(self):
        ...
        :return: deserialized Managed Cluster instance state dictionary
        '''
        self.log("Checking if the Managed Cluster instance {0} is present".format(self.resource_name))
        found = False
        try:
