...
class AzureRMCluster(AzureRMModuleBase):
        ...
        self.module_arg_spec = dict(
            ...
            security_profile=dict(
                ...
                options=dict(
                    directory_type=dict(
                        type='str',
                        choices=['active_directory']
                    ),
                    domain=dict(
                        type='str'
                    ),
                    organizational_unit_dn=dict(
                        type='str'
                    ),
                    ldaps_urls=dict(
                        type='list'
                    ),
                    domain_username=dict(
                        type='str'
                    ),
                    domain_user_password=dict(
                        type='str',
                        no_log=True
                    ),
                    cluster_users_group_dns=dict(
                        type='list'
                    ),
                    aadds_resource_id=dict(
                        type='str'
                    ),
                    msi_resource_id=dict(
                        type='str'
                    )
                )
            ),
    ...
    def exec_module(self, **kwargs):
        ...
        dict_resource_id(self.parameters, ['compute_profile_roles', 'virtual_network_profile', 'id'], subscription_id=self.subscription_id, resource_group=self.resource_group)
