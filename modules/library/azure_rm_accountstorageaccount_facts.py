...
DOCUMENTATION = '''
---
module: azure_rm_accountstorageaccount_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: List instances of Storage Account
    azure_rm_accountstorageaccount_facts:
  ...
  - name: Get instance of Storage Account
    azure_rm_accountstorageaccount_facts:
      resource_group: resource_group_name
      account_name: account_name
...
class AzureRMStorageAccountFacts(AzureRMModuleBase):
    ...
    def list_by_account(self):
        ...
        results = []
        try:
            response = self.mgmt_client.storage_accounts.list_by_account(resource_group_name=self.resource_group,
    ...
    def get(self):
        ...
        results = []
        try:
            response = self.mgmt_client.storage_accounts.get(resource_group_name=self.resource_group,
                                                             account_name=self.account_name,
