...
class AzureRMTransformationFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.job_name = None
        self.name = None
        super(AzureRMTransformationFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Transformation.')
