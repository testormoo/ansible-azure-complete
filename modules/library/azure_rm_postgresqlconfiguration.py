...
version_added: "2.8"
short_description: Manage PostgreSQL Configuration instance.
description:
    - Create, update and delete instance of PostgreSQL Configuration.
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if PostgreSQL Configuration instance has to be deleted or may be updated")
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            ...
            while self.get_postgresqlconfiguration():
                time.sleep(20)
        else:
