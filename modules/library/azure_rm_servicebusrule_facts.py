...
DOCUMENTATION = '''
---
module: azure_rm_servicebusrule_facts
version_added: "2.8"
short_description: Get Azure Rule facts.
description:
    - Get facts of Azure Rule.
...
EXAMPLES = '''
  - name: List instances of Rule
    azure_rm_servicebusrule_facts:
...
RETURN = '''
rules:
    description: A list of dictionaries containing facts for Rule.
    returned: always
    type: complex
    contains:
        id:
            ...
            sample: "/subscriptions/5f750a97-50d9-4e36-8081-c9ee4c0210d4/resourceGroups/ArunMonocle/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace-1
                    319/topics/sdk-Topics-2081/subscriptions/sdk-Subscriptions-8691/rules/sdk-Rules-6571"
        name:
            description:
                - Resource name
            returned: always
            type: str
            sample: sdk-Rules-6571
        action:
            description:
