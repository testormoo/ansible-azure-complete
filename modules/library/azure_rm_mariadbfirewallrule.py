...
class AzureRMFirewallRules(AzureRMModuleBase):
    ...
    def create_update_firewallrule(self):
        ...
        '''
        self.log("Creating / Updating the Firewall Rule instance {0}".format(self.firewall_rule_name))
    ...
    def delete_firewallrule(self):
        ...
        :return: True
        '''
        self.log("Deleting the Firewall Rule instance {0}".format(self.firewall_rule_name))
        try:
    ...
    def get_firewallrule(self):
        ...
        :return: deserialized Firewall Rule instance state dictionary
        '''
        self.log("Checking if the Firewall Rule instance {0} is present".format(self.firewall_rule_name))
        found = False
        try:
