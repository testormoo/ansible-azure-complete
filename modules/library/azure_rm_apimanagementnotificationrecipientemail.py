...
version_added: "2.8"
short_description: Manage Notification Recipient Email instance.
description:
    - Create, update and delete instance of Notification Recipient Email.
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Notification Recipient Email instance has to be deleted or may be updated")
