...
version_added: "2.8"
short_description: Manage Azure Managed Database instance.
description:
    - Create, update and delete instance of Azure Managed Database.
...
class AzureRMManagedDatabase(AzureRMModuleBase):
