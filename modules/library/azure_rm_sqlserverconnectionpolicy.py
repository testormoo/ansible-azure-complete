...
version_added: "2.8"
short_description: Manage Azure Server Connection Policy instance.
description:
    - Create, update and delete instance of Azure Server Connection Policy.
...
class AzureRMServerConnectionPolicy(AzureRMModuleBase):
