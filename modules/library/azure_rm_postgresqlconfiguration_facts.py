...
RETURN = '''
configurations:
    description: A list of dictionaries containing facts for PostgreSQL Configuration.
    returned: always
    type: complex
    contains:
        id:
            ...
            returned: always
            type: str
            sample: "/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/TestGroup/providers/Microsoft.DBforPostgreSQL/servers/testserver/conf
                    igurations/array_nulls"
        name:
            description:
                - Resource name.
            returned: always
...
class AzureRMPostgreSQLConfigurationFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for PostgreSQL Configuration.')
