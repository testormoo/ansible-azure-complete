...
version_added: "2.8"
short_description: Manage Hybrid Connection instance.
description:
    - Create, update and delete instance of Hybrid Connection.
...
class AzureRMHybridConnections(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMHybridConnections, self).__init__(derived_arg_spec=self.module_arg_spec,
