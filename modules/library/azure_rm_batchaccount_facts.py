...
DOCUMENTATION = '''
---
module: azure_rm_batchaccount_facts
version_added: "2.8"
short_description: Get Azure Batch Account facts.
description:
    - Get facts of Azure Batch Account.
...
RETURN = '''
batch_account:
    description: A list of dictionaries containing facts for Batch Account.
    returned: always
    type: complex
    contains:
        id:
