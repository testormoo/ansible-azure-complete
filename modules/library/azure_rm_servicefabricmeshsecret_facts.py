...
DOCUMENTATION = '''
---
module: azure_rm_servicefabricmeshsecret_facts
version_added: "2.8"
        ...
        properties:
            ...
            contains:
                ...
                description:
                    ...
                    returned: always
                    type: str
                    sample: Mongo DB connection string for backend database!
                status:
                    description:
...
class AzureRMSecretFacts(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group is not None and
            ...
            self.results['secret'] = self.list_by_subscription()
        return self.results
    ...
    def list_by_resource_group(self):
        ...
        results = []
        try:
            response = self.mgmt_client.secret.list_by_resource_group(resource_group_name=self.resource_group)
            self.log("Response : {0}".format(response))
        except CloudError as e:
            self.log('Could not get facts for Secret.')
