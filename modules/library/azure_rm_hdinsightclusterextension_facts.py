...
DOCUMENTATION = '''
---
module: azure_rm_hdinsightclusterextension_facts
version_added: "2.8"
short_description: Get Azure Extension facts.
description:
    - Get facts of Extension.
...
EXAMPLES = '''
  - name: Get instance of Extension
    azure_rm_hdinsightclusterextension_facts:
...
RETURN = '''
extension:
    description: A list of dictionaries containing facts for Extensions.
    returned: always
    type: complex
    contains:
'''
...
class AzureRMExtensionFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        super(AzureRMExtensionFacts, self).__init__(self.module_arg_spec)
    ...
    def exec_module(self, **kwargs):
        ...
        if (self.resource_group is not None and
                ...
                self.extension_name is not None):
