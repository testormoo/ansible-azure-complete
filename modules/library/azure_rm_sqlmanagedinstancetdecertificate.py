...
version_added: "2.8"
short_description: Manage Azure Managed Instance Tde Certificate instance.
description:
    - Create, update and delete instance of Azure Managed Instance Tde Certificate.
...
class AzureRMManagedInstanceTdeCertificate(AzureRMModuleBase):
