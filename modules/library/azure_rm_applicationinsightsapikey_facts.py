...
class AzureRMAPIKeyFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        self.key_id = None
        super(AzureRMAPIKeyFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for A P I Key.')
