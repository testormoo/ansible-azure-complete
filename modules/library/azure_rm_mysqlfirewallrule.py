...
version_added: "2.8"
short_description: Manage Azure MySQL Firewall Rule instance.
description:
    - Create, update and delete instance of Azure MySQL Firewall Rule.
...
options:
    ...
    state:
      description:
        - Assert the state of the MySQL Firewall Rule.
        - Use 'present' to create or update an MySQL Firewall Rule and 'absent' to delete it.
      default: present
      choices:
        - absent
        - present
...
class AzureRMMySQLFirewallRule(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        old_response = self.get_mysqlfirewallrule()
        ...
        if (self.to_do == Actions.Create) or (self.to_do == Actions.Update):
            ...
            response = self.create_update_mysqlfirewallrule()
            ...
            self.delete_mysqlfirewallrule()
            # make sure instance is actually deleted, for some Azure resources, instance is hanging around
            # for some time after deletion -- this should be really fixed in Azure.
            while self.get_mysqlfirewallrule():
                time.sleep(20)
        else:
    ...
    def create_update_mysqlfirewallrule(self):
        '''
    ...
    def delete_mysqlfirewallrule(self):
        '''
    ...
    def get_mysqlfirewallrule(self):
        '''
