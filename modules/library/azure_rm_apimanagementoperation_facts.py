...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementoperation_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: List instances of Operation
    azure_rm_apimanagementoperation_facts:
...
class AzureRMOperationFacts(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['operation'] = self.list_by_tags()
        return self.results
    ...
    def list_by_tags(self):
        ...
        results = []
        try:
            response = self.mgmt_client.operation.list_by_tags(resource_group_name=self.resource_group,
