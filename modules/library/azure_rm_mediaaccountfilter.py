...
class AzureRMAccountFilters(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Account Filter instance has to be deleted or may be updated")
    ...
    def create_update_accountfilter(self):
        ...
        '''
        self.log("Creating / Updating the Account Filter instance {0}".format(self.filter_name))
    ...
    def delete_accountfilter(self):
        ...
        :return: True
        '''
        self.log("Deleting the Account Filter instance {0}".format(self.filter_name))
        try:
    ...
    def get_accountfilter(self):
        ...
        :return: deserialized Account Filter instance state dictionary
        '''
        self.log("Checking if the Account Filter instance {0} is present".format(self.filter_name))
        found = False
        try:
