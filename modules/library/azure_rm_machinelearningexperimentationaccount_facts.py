...
DOCUMENTATION = '''
---
module: azure_rm_machinelearningexperimentationaccount_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get instance of Account
    azure_rm_machinelearningexperimentationaccount_facts:
    ...
    contains:
        id:
            ...
            sample: "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/accountcrud-1234/providers/Microsoft.MachineLearningExperimentation/a
                    ccounts/accountcrud5678"
        name:
            description:
                - The name of the resource.
            returned: always
            type: str
            sample: accountcrud5678
        location:
            description:
