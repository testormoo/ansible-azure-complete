...
class AzureRMLogFileFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        super(AzureRMLogFileFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def list_by_server(self):
        ...
        try:
            ...
            self.log('Could not get facts for Log File.')
