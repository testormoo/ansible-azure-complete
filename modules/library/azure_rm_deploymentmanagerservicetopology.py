...
class AzureRMServiceTopologies(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Service Topology instance has to be deleted or may be updated")
    ...
    def create_update_servicetopology(self):
        ...
        '''
        self.log("Creating / Updating the Service Topology instance {0}".format(self.service_topology_name))
    ...
    def delete_servicetopology(self):
        ...
        :return: True
        '''
        self.log("Deleting the Service Topology instance {0}".format(self.service_topology_name))
        try:
    ...
    def get_servicetopology(self):
        ...
        :return: deserialized Service Topology instance state dictionary
        '''
        self.log("Checking if the Service Topology instance {0} is present".format(self.service_topology_name))
        found = False
        try:
