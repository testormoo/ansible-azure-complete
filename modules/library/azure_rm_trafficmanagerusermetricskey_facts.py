...
class AzureRMTrafficManagerUserMetricsKeysFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        super(AzureRMTrafficManagerUserMetricsKeysFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for TrafficManagerUserMetricsKeys.')
...
def main():
    AzureRMTrafficManagerUserMetricsKeysFacts()
