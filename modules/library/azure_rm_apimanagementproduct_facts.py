...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementproduct_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: List instances of Product
    azure_rm_apimanagementproduct_facts:
...
product:
    ...
    contains:
        id:
            ...
            returned: always
            type: str
            sample: /subscriptions/subid/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/products/unlimited
        name:
            description:
                - Resource name.
            returned: always
        ...
        description:
            ...
            returned: always
            type: str
            sample: Subscribers have completely unlimited access to the API. Administrator approval is required.
        state:
            description:
                - "whether product is published or not. Published products are discoverable by users of developer portal. Non published products are visible
                   only to administrators. Default state of Product is notPublished. Possible values include: 'notPublished', 'published'"
            returned: always
            type: str
            sample: published
'''
