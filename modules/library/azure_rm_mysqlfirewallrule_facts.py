...
firewall_rules:
    ...
    contains:
        id:
            ...
            returned: always
            type: str
            sample: "/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/TestGroup/providers/Microsoft.DBforMySQL/servers/testserver/firewallR
                    ules/rule1"
        name:
            description:
                - Resource name.
...
class AzureRMMySQLFirewallRuleFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for MySQL Firewall Rule.')
