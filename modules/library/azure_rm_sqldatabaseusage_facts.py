...
version_added: "2.8"
short_description: Get Azure Database Usage facts.
description:
    - Get facts of Azure Database Usage.
...
RETURN = '''
database_usages:
    description: A list of dictionaries containing facts for Database Usage.
    returned: always
    type: complex
    contains:
'''
...
class AzureRMDatabaseUsagesFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        super(AzureRMDatabaseUsagesFacts, self).__init__(self.module_arg_spec, supports_tags=False)
