...
DOCUMENTATION = '''
---
module: azure_rm_recoveryservicesbackupbackupstatus_facts
version_added: "2.8"
short_description: Get Azure Backup Status facts.
description:
    - Get facts of Azure Backup Status.
...
EXAMPLES = '''
  - name: Get instance of Backup Status
    azure_rm_recoveryservicesbackupbackupstatus_facts:
...
RETURN = '''
backup_status:
    description: A list of dictionaries containing facts for Backup Status.
    returned: always
    type: complex
    contains:
'''
...
class AzureRMBackupStatusFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Backup Status.')
