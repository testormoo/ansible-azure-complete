...
version_added: "2.8"
short_description: Manage Tag instance.
description:
    - Create, update and delete instance of Tag.
...
options:
    ...
    state:
      description:
        ...
        - Use 'present' to create or update an Tag and 'absent' to delete it.
      default: present
      choices:
        - absent
        - present
...
class AzureRMTag(AzureRMModuleBase):
    ...
    def create_update_tag(self):
        ...
        '''
        self.log("Creating / Updating the Tag instance {0}".format(self.tag_id))
    ...
    def delete_tag(self):
        ...
        :return: True
        '''
        self.log("Deleting the Tag instance {0}".format(self.tag_id))
        try:
    ...
    def get_tag(self):
        ...
        :return: deserialized Tag instance state dictionary
        '''
        self.log("Checking if the Tag instance {0} is present".format(self.tag_id))
        found = False
        try:
