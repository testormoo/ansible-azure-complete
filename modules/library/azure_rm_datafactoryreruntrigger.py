...
version_added: "2.8"
short_description: Manage Azure Rerun Trigger instance.
description:
    - Create, update and delete instance of Azure Rerun Trigger.
...
class AzureRMRerunTrigger(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMRerunTrigger, self).__init__(derived_arg_spec=self.module_arg_spec,
    ...
    def exec_module(self, **kwargs):
        ...
        for key in list(self.module_arg_spec.keys()):
            if hasattr(self, key):
                ...
                self.rerun_tumbling_window_trigger_action_parameters[key] = kwargs[key]
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                if (not default_compare(self.rerun_tumbling_window_trigger_action_parameters, old_response, '', self.results)):
