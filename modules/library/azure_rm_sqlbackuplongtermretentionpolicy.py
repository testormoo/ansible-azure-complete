...
class AzureRMBackupLongTermRetentionPolicies(AzureRMModuleBase):
    ...
    def create_update_backuplongtermretentionpolicy(self):
        ...
        '''
        self.log("Creating / Updating the Backup Long Term Retention Policy instance {0}".format(self.policy_name))
    ...
    def delete_backuplongtermretentionpolicy(self):
        ...
        :return: True
        '''
        self.log("Deleting the Backup Long Term Retention Policy instance {0}".format(self.policy_name))
        try:
    ...
    def get_backuplongtermretentionpolicy(self):
        ...
        :return: deserialized Backup Long Term Retention Policy instance state dictionary
        '''
        self.log("Checking if the Backup Long Term Retention Policy instance {0} is present".format(self.policy_name))
        found = False
        try:
