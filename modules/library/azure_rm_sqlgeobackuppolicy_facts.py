...
version_added: "2.8"
short_description: Get Azure Geo Backup Policy facts.
description:
    - Get facts of Azure Geo Backup Policy.
...
RETURN = '''
geo_backup_policies:
    description: A list of dictionaries containing facts for Geo Backup Policy.
    returned: always
    type: complex
    contains:
        id:
            ...
            returned: always
            type: str
            sample: "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/sqlcrudtest-4799/providers/Microsoft.Sql/servers/sqlcrudtest-5961/dat
                    abases/testdw/geoBackupPolicies/Default"
        name:
            description:
                - Resource name.
            returned: always
...
class AzureRMGeoBackupPolicyFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        super(AzureRMGeoBackupPolicyFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Geo Backup Policy.')
