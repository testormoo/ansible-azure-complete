...
version_added: "2.8"
short_description: Manage Query Key instance.
description:
    - Create, update and delete instance of Query Key.
...
class AzureRMQueryKeys(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMQueryKeys, self).__init__(derived_arg_spec=self.module_arg_spec,
