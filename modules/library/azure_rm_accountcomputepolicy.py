...
version_added: "2.8"
short_description: Manage Azure Compute Policy instance.
description:
    - Create, update and delete instance of Azure Compute Policy.
...
class AzureRMComputePolicy(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        dict_camelize(self.parameters, ['object_type'], True)
