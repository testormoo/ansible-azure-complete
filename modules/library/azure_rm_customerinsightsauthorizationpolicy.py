...
version_added: "2.8"
short_description: Manage Azure Authorization Policy instance.
description:
    - Create, update and delete instance of Azure Authorization Policy.
...
class AzureRMAuthorizationPolicy(AzureRMModuleBase):
