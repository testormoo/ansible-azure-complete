...
DOCUMENTATION = '''
---
module: azure_rm_deploymentmanagerservicetopology_facts
version_added: "2.8"
short_description: Get Azure Service Topology facts.
description:
    - Get facts of Azure Service Topology.
...
RETURN = '''
service_topologies:
    description: A list of dictionaries containing facts for Service Topology.
    returned: always
    type: complex
    contains:
        id:
...
class AzureRMServiceTopologiesFacts(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['service_topologies'] = self.get()
        return self.results
