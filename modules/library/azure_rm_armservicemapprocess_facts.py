...
DOCUMENTATION = '''
---
module: azure_rm_armservicemapprocess_facts
version_added: "2.8"
short_description: Get Azure Process facts.
description:
    - Get facts of Azure Process.
...
EXAMPLES = '''
  - name: Get instance of Process
    azure_rm_armservicemapprocess_facts:
...
RETURN = '''
processes:
    description: A list of dictionaries containing facts for Process.
    returned: always
    type: complex
    contains:
        id:
...
class AzureRMProcessFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        self.timestamp = None
        super(AzureRMProcessFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Process.')
