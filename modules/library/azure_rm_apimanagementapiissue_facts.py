...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementapiissue_facts
version_added: "2.8"
short_description: Get Azure Api Issue facts.
description:
    - Get facts of Azure Api Issue.
...
RETURN = '''
api_issue:
    description: A list of dictionaries containing facts for Api Issue.
    returned: always
    type: complex
    contains:
        id:
        ...
        title:
            ...
            returned: always
            type: str
            sample: New API issue
        description:
            description:
                - Text describing the issue.
            returned: always
            type: str
            sample: New API issue description
        state:
            description:
...
class AzureRMApiIssueFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.skip = None
        self.issue_id = None
        super(AzureRMApiIssueFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def exec_module(self, **kwargs):
        ...
        if self.issue_id is not None:
            ...
            self.results['api_issue'] = self.list_by_service()
        return self.results
    ...
    def list_by_service(self):
        ...
        try:
            ...
            self.log('Could not get facts for Api Issue.')
