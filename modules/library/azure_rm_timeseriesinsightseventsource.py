...
version_added: "2.8"
short_description: Manage Azure Event Source instance.
description:
    - Create, update and delete instance of Azure Event Source.
...
class AzureRMEventSource(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMEventSource, self).__init__(derived_arg_spec=self.module_arg_spec,
