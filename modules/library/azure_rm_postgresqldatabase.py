...
version_added: "2.8"
short_description: Manage Azure PostgreSQL Database instance.
description:
    - Create, update and delete instance of Azure PostgreSQL Database.
...
class AzureRMPostgreSQLDatabase(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMPostgreSQLDatabase, self).__init__(derived_arg_spec=self.module_arg_spec,
