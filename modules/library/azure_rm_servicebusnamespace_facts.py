...
DOCUMENTATION = '''
---
module: azure_rm_servicebusnamespace_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get instance of Namespace
    azure_rm_servicebusnamespace_facts:
...
namespaces:
    ...
    contains:
        id:
            ...
            returned: always
            type: str
            sample: /subscriptions/5f750a97-50d9-4e36-8081-c9ee4c0210d4/resourceGroups/ArunMonocle/providers/Microsoft.ServiceBus/namespaces/sdk-Namespace-2924
        name:
            description:
                - Resource name
            returned: always
            type: str
            sample: sdk-Namespace-2924
        location:
            description:
