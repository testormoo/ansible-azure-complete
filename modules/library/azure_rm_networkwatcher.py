...
version_added: "2.8"
short_description: Manage Azure Network Watcher instance.
description:
    - Create, update and delete instance of Azure Network Watcher.
...
class AzureRMNetworkWatcher(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMNetworkWatcher, self).__init__(derived_arg_spec=self.module_arg_spec,
