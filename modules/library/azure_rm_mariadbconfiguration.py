...
class AzureRMConfigurations(AzureRMModuleBase):
    ...
    def create_update_configuration(self):
        ...
        '''
        self.log("Creating / Updating the Configuration instance {0}".format(self.configuration_name))
    ...
    def delete_configuration(self):
        ...
        :return: True
        '''
        self.log("Deleting the Configuration instance {0}".format(self.configuration_name))
        try:
    ...
    def get_configuration(self):
        ...
        :return: deserialized Configuration instance state dictionary
        '''
        self.log("Checking if the Configuration instance {0} is present".format(self.configuration_name))
        found = False
        try:
