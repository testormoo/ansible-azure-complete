...
DOCUMENTATION = '''
---
module: azure_rm_apimanagementnetworkstatu_facts
version_added: "2.8"
short_description: Get Azure Network Statu facts.
description:
    - Get facts of Azure Network Statu.
...
EXAMPLES = '''
  - name: List instances of Network Statu
    azure_rm_apimanagementnetworkstatu_facts:
...
RETURN = '''
network_status:
    description: A list of dictionaries containing facts for Network Statu.
    returned: always
    type: complex
    contains:
'''
