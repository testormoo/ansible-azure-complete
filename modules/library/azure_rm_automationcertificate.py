...
DOCUMENTATION = '''
---
module: azure_rm_automationcertificate
version_added: "2.8"
...
EXAMPLES = '''
  - name: Create (or update) Certificate
    azure_rm_automationcertificate:
      resource_group: rg
    ...
    def exec_module(self, **kwargs):
        ...
        for key in list(self.module_arg_spec.keys()) + ['tags']:
            if hasattr(self, key):
                ...
                elif key == "base64_value":
                    self.parameters["base64_value"] = kwargs[key]
                elif key == "description":
                    self.parameters["description"] = kwargs[key]
                elif key == "thumbprint":
                    self.parameters["thumbprint"] = kwargs[key]
                elif key == "is_exportable":
                    self.parameters["is_exportable"] = kwargs[key]
