...
class AzureRMWorkflowRunsFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.run_name = None
        super(AzureRMWorkflowRunsFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for WorkflowRuns.')
