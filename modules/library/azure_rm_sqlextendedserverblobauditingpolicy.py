...
version_added: "2.8"
short_description: Manage Azure Extended Server Blob Auditing Policy instance.
description:
    - Create, update and delete instance of Azure Extended Server Blob Auditing Policy.
...
class AzureRMExtendedServerBlobAuditingPolicy(AzureRMModuleBase):
