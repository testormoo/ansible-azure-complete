...
class AzureRMExtendedServerBlobAuditingPolicies(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Extended Server Blob Auditing Policy instance has to be deleted or may be updated")
    ...
    def create_update_extendedserverblobauditingpolicy(self):
        ...
        '''
        self.log("Creating / Updating the Extended Server Blob Auditing Policy instance {0}".format(self.blob_auditing_policy_name))
    ...
    def delete_extendedserverblobauditingpolicy(self):
        ...
        :return: True
        '''
        self.log("Deleting the Extended Server Blob Auditing Policy instance {0}".format(self.blob_auditing_policy_name))
        try:
    ...
    def get_extendedserverblobauditingpolicy(self):
        ...
        :return: deserialized Extended Server Blob Auditing Policy instance state dictionary
        '''
        self.log("Checking if the Extended Server Blob Auditing Policy instance {0} is present".format(self.blob_auditing_policy_name))
        found = False
        try:
