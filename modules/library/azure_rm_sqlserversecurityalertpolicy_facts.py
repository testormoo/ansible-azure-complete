...
DOCUMENTATION = '''
---
module: azure_rm_sqlserversecurityalertpolicy_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: Get instance of Server Security Alert Policy
    azure_rm_sqlserversecurityalertpolicy_facts:
...
server_security_alert_policies:
    ...
    contains:
        id:
            ...
            returned: always
            type: str
            sample: "/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/securityalert-4799/providers/Microsoft.Sql/servers/securityalert-6440
        ...
        state:
            description:
                - "Specifies the state of the policy, whether it is enabled or disabled. Possible values include: 'New', 'Enabled', 'Disabled'"
            returned: always
            type: str
            sample: Disabled
'''
