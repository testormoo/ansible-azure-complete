...
class AzureRMJobStepFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        super(AzureRMJobStepFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def list_by_version(self):
        ...
        try:
            ...
            self.log('Could not get facts for Job Step.')
