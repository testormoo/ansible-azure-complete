...
DOCUMENTATION = '''
---
module: azure_rm_sqlelasticpooloperation_facts
version_added: "2.8"
short_description: Get Azure Elastic Pool Operation facts.
description:
    - Get facts of Azure Elastic Pool Operation.
...
EXAMPLES = '''
  - name: List instances of Elastic Pool Operation
...
elastic_pool_operations:
    description: A list of dictionaries containing facts for Elastic Pool Operation.
    returned: always
    type: complex
    contains:
'''
...
class AzureRMElasticPoolOperationFacts(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['elastic_pool_operations'] = self.list_by_elastic_pool()
        return self.results
