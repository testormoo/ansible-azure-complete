...
DOCUMENTATION = '''
---
module: azure_rm_mariadbvirtualnetworkrule
version_added: "2.8"
...
EXAMPLES = '''
  - name: Create (or update) Virtual Network Rule
    azure_rm_mariadbvirtualnetworkrule:
...
id:
    ...
    returned: always
    type: str
    sample: "/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/TestGroup/providers/Microsoft.DBforMariaDB/servers/vnet-test-svr/virtualNetwo
