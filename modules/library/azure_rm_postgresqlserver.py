...
version_added: "2.8"
short_description: Manage Azure PostgreSQL Server instance.
description:
    - Create, update and delete instance of Azure PostgreSQL Server.
...
class AzureRMPostgreSQLServer(AzureRMModuleBase):
    ...
    def __init__(self):
        ...
        super(AzureRMPostgreSQLServer, self).__init__(derived_arg_spec=self.module_arg_spec,
    ...
    def exec_module(self, **kwargs):
        ...
        if self.state == 'present':
            self.results.update({
                ...
                'state': response.get('user_visible_state', None),
