...
class AzureRMJobCredentials(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Job Credential instance has to be deleted or may be updated")
    ...
    def create_update_jobcredential(self):
        ...
        '''
        self.log("Creating / Updating the Job Credential instance {0}".format(self.credential_name))
    ...
    def delete_jobcredential(self):
        ...
        :return: True
        '''
        self.log("Deleting the Job Credential instance {0}".format(self.credential_name))
        try:
    ...
    def get_jobcredential(self):
        ...
        :return: deserialized Job Credential instance state dictionary
        '''
        self.log("Checking if the Job Credential instance {0} is present".format(self.credential_name))
        found = False
        try:
