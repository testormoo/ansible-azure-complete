...
version_added: "2.8"
short_description: Manage Azure Job Credential instance.
description:
    - Create, update and delete instance of Azure Job Credential.
...
class AzureRMJobCredential(AzureRMModuleBase):
