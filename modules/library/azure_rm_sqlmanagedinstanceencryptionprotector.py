...
version_added: "2.8"
short_description: Manage Azure Managed Instance Encryption Protector instance.
description:
    - Create, update and delete instance of Azure Managed Instance Encryption Protector.
...
class AzureRMManagedInstanceEncryptionProtector(AzureRMModuleBase):
