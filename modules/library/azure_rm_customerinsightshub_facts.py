...
DOCUMENTATION = '''
---
module: azure_rm_customerinsightshub_facts
version_added: "2.8"
short_description: Get Azure Hub facts.
description:
    - Get facts of Azure Hub.
...
RETURN = '''
hubs:
    description: A list of dictionaries containing facts for Hub.
    returned: always
    type: complex
    contains:
        id:
