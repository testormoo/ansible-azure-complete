...
class AzureRMTransforms(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if not old_response:
            ...
            if self.state == 'absent':
                ...
                self.log("Need to check if Transform instance has to be deleted or may be updated")
    ...
    def create_update_transform(self):
        ...
        '''
        self.log("Creating / Updating the Transform instance {0}".format(self.transform_name))
    ...
    def delete_transform(self):
        ...
        :return: True
        '''
        self.log("Deleting the Transform instance {0}".format(self.transform_name))
        try:
    ...
    def get_transform(self):
        ...
        :return: deserialized Transform instance state dictionary
        '''
        self.log("Checking if the Transform instance {0} is present".format(self.transform_name))
        found = False
        try:
