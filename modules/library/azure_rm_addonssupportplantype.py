...
version_added: "2.8"
short_description: Manage Azure Support Plan Type instance.
description:
    - Create, update and delete instance of Azure Support Plan Type.
...
class AzureRMSupportPlanType(AzureRMModuleBase):
