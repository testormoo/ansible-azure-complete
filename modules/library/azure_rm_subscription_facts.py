...
DOCUMENTATION = '''
---
module: azure_rm_subscription_facts
version_added: "2.8"
...
subscriptions:
    ...
    contains:
        ...
        state:
            description:
                - "The subscription state. Possible values are Enabled, Warned, PastDue, Disabled, and Deleted. Possible values include: 'Enabled',
...
class AzureRMSubscriptionsFacts(AzureRMModuleBase):
    ...
    def get(self):
        ...
        results = []
        try:
            response = self.mgmt_client.subscriptions.get(subscription_id=self.subscription_id)
