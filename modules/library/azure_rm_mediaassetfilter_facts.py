...
DOCUMENTATION = '''
---
module: azure_rm_mediaassetfilter_facts
version_added: "2.8"
short_description: Get Azure Asset Filter facts.
description:
    - Get facts of Azure Asset Filter.
...
EXAMPLES = '''
  - name: Get instance of Asset Filter
    azure_rm_mediaassetfilter_facts:
...
RETURN = '''
asset_filters:
    description: A list of dictionaries containing facts for Asset Filter.
    returned: always
    type: complex
    contains:
        id:
            ...
            sample: "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contoso/providers/Microsoft.Media/mediaservices/contosomedia/assets/C
                    limbingMountRainer/assetFilters/assetFilterWithTimeWindowAndTrack"
        name:
            description:
                - The name of the resource.
            returned: always
            type: str
            sample: assetFilterWithTimeWindowAndTrack
        tracks:
            description:
...
class AzureRMAssetFiltersFacts(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        self.results['asset_filters'] = self.get()
        return self.results
