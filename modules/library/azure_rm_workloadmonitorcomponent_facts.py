...
DOCUMENTATION = '''
---
module: azure_rm_workloadmonitorcomponent_facts
version_added: "2.8"
...
EXAMPLES = '''
  - name: List instances of Component
    azure_rm_workloadmonitorcomponent_facts:
    ...
    contains:
        id:
            ...
            sample: "/subscriptions/a7f23fdb-e626-4f95-89aa-3a360a90861e/resourcegroups/viv_rg/providers/Microsoft.WorkloadMonitor/workloadInsights/Canary-WL
                    I-2/components/ComponentId='d91ce384-b682-883a-d02b-129bf37f218b'"
        name:
            description:
                - The name of the resource
            returned: always
            type: str
            sample: "ComponentId='d91ce384-b682-883a-d02b-129bf37f218b'"
        etag:
            description:
...
class AzureRMComponentsFacts(AzureRMModuleBase):
    ...
    def list_by_resource(self):
        ...
        results = []
        try:
            response = self.mgmt_client.components.list_by_resource(resource_group_name=self.resource_group,
