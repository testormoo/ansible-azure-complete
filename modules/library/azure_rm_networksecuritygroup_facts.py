...
DOCUMENTATION = '''
---
module: azure_rm_networksecuritygroup_facts
version_added: "2.8"
short_description: Get Azure Network Security Group facts.
description:
    - Get facts of Azure Network Security Group.
...
network_security_groups:
    description: A list of dictionaries containing facts for Network Security Group.
    returned: always
    type: complex
    contains:
        id:
