...
DOCUMENTATION = '''
---
module: azure_rm_recoveryservicesbackupbackupoperationstatuse_facts
version_added: "2.8"
short_description: Get Azure Backup Operation Statuse facts.
description:
    - Get facts of Azure Backup Operation Statuse.
...
EXAMPLES = '''
  - name: Get instance of Backup Operation Statuse
    azure_rm_recoveryservicesbackupbackupoperationstatuse_facts:
...
backup_operation_statuses:
    description: A list of dictionaries containing facts for Backup Operation Statuse.
    returned: always
    type: complex
    contains:
        id:
