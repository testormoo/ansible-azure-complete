...
class AzureRMSignInSettingFacts(AzureRMModuleBase):
    def __init__(self):
        ...
        self.name = None
        super(AzureRMSignInSettingFacts, self).__init__(self.module_arg_spec, supports_tags=False)
    ...
    def get(self):
        ...
        try:
            ...
            self.log('Could not get facts for Sign In Setting.')
